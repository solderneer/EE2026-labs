...
HD_PWD='C:/Users/Auora/Documents/EE2026_labs/debounced_counter/debounced_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledarray_counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ledarray_counter.tcl
