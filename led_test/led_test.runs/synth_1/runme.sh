...
HD_PWD='C:/Users/solderneer/led_test/led_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_control_module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_control_module.tcl
