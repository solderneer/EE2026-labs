...
HD_PWD='C:/Users/solderneer/led_test/led_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_control_module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source my_control_module.tcl -notrace
