...
HD_PWD='C:/Users/solderneer/mux_test/mux_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mux_test.tcl -notrace
